...
/**
 * Contains integration tests (interaction with the SeplendidModel) for {@code NoteUpdateCommand}.
 */
public class NoteUpdateCommandIntegrationTest {
    ...
    public void execute_updateNote_success() throws CommandException {
        ...
        NoteUpdateCommand noteUpdateCommand = new NoteUpdateCommand(1, new Content("Updated content"));
        CommandResult commandResult = noteUpdateCommand.execute(model);
        Note updatedNote = model.getNoteCatalogue().getNoteList().get(0);

        assertEquals(String.format(NoteUpdateCommand.MESSAGE_SUCCESS, Messages.format(updatedNote)),
    ...
    public void execute_updateNoteInvalidNegativeIndex_throwsCommandException() throws CommandException {
        ...
        NoteUpdateCommand noteUpdateCommand = new NoteUpdateCommand(-1,
                new Content("Updated content"));

        assertThrows(CommandException.class, () -> noteUpdateCommand.execute(model));
    }
    ...
    public void execute_updateNoteInvalidVeryLargeIndex_throwsCommandException() throws CommandException {
        ...
        NoteUpdateCommand noteUpdateCommand = new NoteUpdateCommand(1234566789,
                new Content("Updated content"));
