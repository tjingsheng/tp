...
public class TypicalObjects {
    ...
    public static final LocalCourse CS2040S = new LocalCourseBuilder().withLocalCode("CS2040S")
                                                                      ...
                                                                      .withLocalUnit(4.0)
                                                                      .withLocalDescription("Fun course about algos.")
                                                                      .build();
    ...
    public static final LocalCourse TYPICAL_LOCAL_COURSE =
        new LocalCourseBuilder().withLocalCode(TYPICAL_LOCAL_COURSE_CODE)
                                ...
                                .withLocalDescription(TYPICAL_LOCAL_COURSE_DESCRIPTION)
                                .build();
    ...
    public static final PartnerCourse S0402SC =
        new PartnerCourseBuilder().withPartnerUniversity(new UniversityName("Nanyang Technological University"))
                                  .withPartnerCode("S0402SC")
                                  .withPartnerName("Algorithms")
                                  .build();
    public static final PartnerCourse STAN3230 =
        new PartnerCourseBuilder().withPartnerUniversity(new UniversityName("Stanford University"))
                                  .withPartnerCode("STAN3230")
                                  .withPartnerName("Design & Analysis of Algorithms")
                                  .build();
    ...
    // Mapping
    public static final Mapping CS2040S_TO_NTU_S0402SC =
        new Mapping(CS2040S.getLocalCode(), NTU.getUniversityName(), S0402SC.getPartnerCode(),
            new MappingMiscInformation("NIL"));
    public static final Mapping CS3230S_TO_STANFORD_STAN3230 =
        new Mapping(CS3230.getLocalCode(), STANFORD.getUniversityName(), STAN3230.getPartnerCode(),
            new MappingMiscInformation("NIL"));
