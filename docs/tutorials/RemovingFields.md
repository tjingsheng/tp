...
``` xml
...
<Label fx:id="phone" styleClass="text-font-size" text="\$phone" />
<Label fx:id="address" styleClass="text-font-size" text="\$address" />
<Label fx:id="email" styleClass="text-font-size" text="\$email" />
...
```
