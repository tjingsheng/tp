...
public class JsonSerializableNoteCatalogueTest {
    ...
    private static final Path TEST_DATA_FOLDER = Paths.get("src", "test", "data", "JsonSerializableNoteCatalogueTest");

    private static final Path TYPICAL_NOTES_FILE = TEST_DATA_FOLDER.resolve("typicalNoteCatalogue.json");

    private static final Path INVALID_NOTES_EMPTY_CONTENT_FILE = TEST_DATA_FOLDER.resolve("invalidNoteEmptyContentInCatalogue.json");

    private static final Path INVALID_NOTES_INDEX_FILE = TEST_DATA_FOLDER.resolve("invalidNoteIndexInCatalogue.json");

    private static final Path INVALID_NOTES_DUPLICATE_INDEX_FILE = TEST_DATA_FOLDER.resolve("invalidNoteDuplicateIndexInCatalogue.json");
