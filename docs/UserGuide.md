...
5. [Commands](#5-commands)
   - 5.1 [Commands for local courses](#5-1-commands-for-local-courses)
     ...
     - 5.1.5 [Search for a local course by an attribute: `localcourse search`](#5-1-5-search-for-a-local-course-by-an-attribute-localcourse-search)
   ...
   - 5.2 [Commands for partner courses](#5-2-commands-for-partner-courses)
     ...
     - 5.2.5 [Search for a partner course by an attribute: `partnercourse search`](#5-2-5-search-for-a-partner-course-by-an-attribute-partnercourse-search)
   ...
   - 5.3 [Commands for universities](#5-3-commands-for-universities)
     ...
     - 5.3.2 [Search for a university by an attribute: `university search`](#5-3-2-search-for-a-university-by-an-attribute-university-search)
   ...
   - 5.4 [Commands for mappings](#5-4-commands-for-mappings)
     ...
     - 5.4.4 [Search for a mapping by an attribute: `mapping search`](#5-4-4-search-a-mapping-by-attributes-mapping-search)
     - 5.4.5 [Sort all mappings by an attribute: `mapping sort`](#5-4-5-sort-a-mapping-by-attributes-mapping-sort)
...
- you wish to search for your notes with the tags you are interested in. 
