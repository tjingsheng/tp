 ...
 */
public class SeplendidLogsCenter {
    private static final int MAX_FILE_COUNT = 5;
    private static final int MAX_FILE_SIZE_IN_BYTES = (int) (Math.pow(2, 20) * 5); // 5MB
    private static final String LOG_FILE = "seplendid.log";
    ...
    static {
        setBaseLogger();
        logger = SeplendidLogsCenter.getLogger(SeplendidLogsCenter.class);
    }
    ...
    /**
     * Creates a logger named 'seplendidbaselogger', containing a {@code ConsoleHandler} and a {@code FileHandler}.
     * Sets it as the {@code baseLogger}, to be used as the parent logger of all other loggers.
     */
    private static void setBaseLogger() {
        baseLogger = Logger.getLogger("seplendidbaselogger");
