...
import static seedu.address.messages.Messages.MESSAGE_INVALID_COMMAND_FORMAT;
...
import static seedu.address.testutil.TypicalIndexes.INDEX_THIRD_OBJECT;
...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_TAG_DESC, ConstraintMessage.TAG_NAME.getValue()); // invalid tag
        ...
        assertParseFailure(parser, "1" + TAG_DESC_FRIEND + TAG_DESC_HUSBAND + TAG_EMPTY,
                           ConstraintMessage.TAG_NAME.getValue());
